...
- 🌐 **Multilingual Support**: Support for multiple languages (English, Korean, Chinese, Japanese, Spanish, French, German, Portuguese)
...
Korean, Chinese, Japanese, Spanish, French, German, and Portuguese planetary labels are supported with
...
`Mont Olympe` in French, `Olympusberg` in German, and `Monte Olimpo` in
Portuguese.
...
Japanese, French, German, and Portuguese labels are also available:
...
- 🌐 **Language**: Select from supported languages (English, Korean, Chinese, Japanese, Spanish, French, German, Portuguese)
