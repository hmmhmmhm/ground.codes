...
The authoritative coverage baseline was measured on 2026-07-14 with Bun
1.3.1 and c8 11.0.0. Line and function minimums are fixed at 0.8 for every
target. Branch minimums are each measured ratio rounded down by less than
0.001.
...
| api          | 1847/2005 (0.9211970074812967) | 115/130 (0.8846153846153846) | 255/351 (0.7264957264957265) |          0.726 |
...
Coverage thresholds may only increase. A changed source boundary or
instrumentation tool requires a newly documented measurement; it must not be
used to hide a regression.
