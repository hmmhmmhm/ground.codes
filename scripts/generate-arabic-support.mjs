...
import {
  ...
  blockedTokens,
  standaloneWords,
} from "./data/arabic-codebook-base.mjs";
import {
  natureRoots,
  plantRoots,
  objectRoots,
  ...
  materialRoots,
  foodRoots,
} from "./data/arabic-codebook-parts.mjs";
import {
  arabicRegionOverrides,
  latinMap,
  marineTerms,
  marineProperFragments,
  planetaryExactNames,
  planetaryLeadingTerms,
} from "./data/arabic-regions.mjs";
...
writeJson("packages/codebook/codebook-dist/arabic.json", buildArabicCodebook());
