  ...
  <body>
    <main>
      ...
      <div class="grid">
        ...
        <section>
          <h2>Languages</h2>
          <p>Ground Codes supports <code>english</code>, <code>korean</code>, <code>chinese</code>, <code>japanese</code>, <code>spanish</code>, <code>french</code>, and <code>german</code> for codebooks and localized region labels.</p>
        </section>
        <section>
