...
import {
  standaloneWords,
  additionalStandaloneWords,
} from "./data/indonesian-codebook-words.mjs";
import {
  prefixes,
  naturalCompoundSuffixes,
  suffixes,
  blockedCodebookWords,
} from "./data/indonesian-codebook-parts.mjs";
import {
  awkwardAdjectivePrefixes,
  awkwardAdjectiveSuffixes,
  awkwardObjectPrefixes,
  awkwardObjectSuffixes,
  awkwardUniversalObjectSuffixes,
  allowedSelfRepeatingWords,
} from "./data/indonesian-codebook-policy.mjs";
import {
  earthNameOverridesByCode,
  marineTerms,
  planetaryPhraseOverrides,
  planetaryTerms,
} from "./data/indonesian-regions.mjs";
