...
const waterPlaceSuffixes = ["sen", "cá", "bè", "thuyền", "cát", "sỏi", "đá"];
...
const terrainPlaceSuffixes = ["đá", "cát", "sỏi", "cây", "hoa", "trúc"];
...
const colorRoots = ["áo", "nón", "mũ", "khăn", "túi", "hoa"];
...
const shopRoots = ["quán", "tiệm", "hàng"];
const shopSuffixes = [
  "cơm",
  "phở",
  "bún",
...
const laneRoots = ["đường", "lối", "ngõ", "hẻm"];
const laneSuffixes = [
  "hoa",
  "tre",
  "trúc",
...
const roomRoots = ["phòng", "nhà", "góc", "sân"];
const roomSuffixes = [
  "sách",
  "trà",
  "hoa",
...
const craftPlaceRoots = ["làng", "xưởng", "nhà"];
const craftPlaceSuffixes = [
  "gốm",
  "lụa",
  "mây",
  "tre",
