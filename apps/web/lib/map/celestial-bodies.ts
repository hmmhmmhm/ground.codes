...
> = {
  moon: [
    ...
    { id: "mare-smythii", name: "Mare Smythii", lat: -1.7, lng: 87 },
    { id: "mare-marginis", name: "Mare Marginis", lat: 12.7, lng: 86.5 },
    { id: "mare-moscoviense", name: "Mare Moscoviense", lat: 27.3, lng: 148.1 },
    { id: "mare-ingenii", name: "Mare Ingenii", lat: -33.2, lng: 164.8 },
    { id: "mare-australe", name: "Mare Australe", lat: -47.8, lng: 92 },
    { id: "tsiolkovskiy", name: "Tsiolkovskiy", lat: -20.4, lng: 129 },
    { id: "korolev", name: "Korolev", lat: -4.2, lng: -157.4 },
    { id: "von-karman", name: "Von Karman", lat: -44.5, lng: 176.2 },
    { id: "mendeleev", name: "Mendeleev", lat: 5.4, lng: 141.2 },
    { id: "giordano-bruno", name: "Giordano Bruno", lat: 36, lng: 102.9 },
    { id: "mare-orientale", name: "Mare Orientale", lat: -19.9, lng: -94.7 },
    { id: "hertzsprung", name: "Hertzsprung", lat: 1.4, lng: -128.7 },
  ],
  mars: [
    ...
    { id: "ascraeus-mons", name: "Ascraeus Mons", lat: 11.9, lng: -104.1 },
    { id: "pavonis-mons", name: "Pavonis Mons", lat: 1.5, lng: -113 },
    { id: "isidis-planitia", name: "Isidis Planitia", lat: 13.9, lng: 88.4 },
    { id: "arabia-terra", name: "Arabia Terra", lat: 21.2, lng: 5.7 },
    { id: "meridiani-planum", name: "Meridiani Planum", lat: 0, lng: -3.1 },
    { id: "chryse-planitia", name: "Chryse Planitia", lat: 28.4, lng: -40.3 },
    {
    ...
    { id: "arcadia-planitia", name: "Arcadia Planitia", lat: 49, lng: -171.9 },
    { id: "argyre-planitia", name: "Argyre Planitia", lat: -49.8, lng: -43.3 },
    { id: "terra-cimmeria", name: "Terra Cimmeria", lat: -32.7, lng: 147.7 },
  ],
};
